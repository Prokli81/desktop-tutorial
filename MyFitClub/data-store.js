const MyFitClubStore = (() => {
  ...
  const seed = {
    ...
    scheduleEvents: [
      {
        id: "event-functional-morning",
        title: "Утренняя функциональная",
        trainer: "Алексей Орлов",
        place: "Зал 1",
        date: "Пт, 08:00",
        description: "Круговая тренировка для энергии и выносливости.",
        capacity: 14,
      },
      {
        id: "event-yoga-mobility",
        title: "Йога и мобильность",
        trainer: "Мария Соколова",
        place: "Зал 2",
        date: "Пт, 18:00",
        description: "Мягкая практика для спины, дыхания и восстановления.",
        capacity: 18,
      },
      {
        id: "event-strength-technique",
        title: "Силовая техника",
        trainer: "Алексей Орлов",
        place: "Зал 1",
        date: "Сб, 12:00",
        description: "Разбор приседа, тяги и безопасной работы с весами.",
        capacity: 10,
      },
      {
        id: "event-club-challenge",
        title: "Клубный челлендж",
        trainer: "Команда тренеров",
        place: "Главный зал",
        date: "Вс, 11:00",
        description: "Командная тренировка и мини-соревнование для участников.",
        capacity: 30,
      },
    ],
    clubMessages: [],
